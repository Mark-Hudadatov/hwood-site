...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  },
  {
    ...
    description: 'Built-in drawer units for wardrobes',
    sortOrder: 3,
  },
  ...
  // --- Painted MDF (sub-8) ---
  {
    ...
    subserviceId: 'sub-8',
    title: 'Flat Panel',
    description: 'Smooth flat panel MDF fronts',
    sortOrder: 1,
  },
  {
    id: 'cat-12',
    ...
    subserviceId: 'sub-8',
    title: 'Shaker Style',
    description: 'Classic shaker profile MDF fronts',
    sortOrder: 2,
  },
  {
    id: 'cat-13',
    ...
    subserviceId: 'sub-8',
    title: 'Raised Panel',
    description: 'Traditional raised panel MDF fronts',
    sortOrder: 3,
  },
];
...
export const PRODUCTS: Product[] = [
  // --- Kitchen Modules > Upper Cabinets (cat-1) ---
  {
    ...
    categoryId: 'cat-1',
    title: 'Upper Cabinet 600',
    subtitle: 'Standard wall cabinet',
    description: 'Versatile wall-mounted cabinet module designed for maximum storage efficiency. Features adjustable shelving and soft-close hinges as standard.',
    imageUrl: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&q=80&w=800',
    features: ['Soft-close hinges', 'Adjustable shelves', '18mm panels', 'ABS edge banding'],
    specifications: [
  ...
  },
  {
    ...
    categoryId: 'cat-1',
    title: 'Upper Corner Cabinet',
    subtitle: 'L-shaped corner unit',
    description: 'Optimized corner solution that maximizes storage in L-shaped kitchen layouts.',
    imageUrl: 'https://images.unsplash.com/photo-1556909172-54557c7e4fb7?auto=format&fit=crop&q=80&w=800',
    features: ['Rotating carousel option', 'Bi-fold doors', 'Maximum corner utilization'],
    specifications: [
